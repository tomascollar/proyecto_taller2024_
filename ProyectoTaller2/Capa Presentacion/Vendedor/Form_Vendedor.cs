...
namespace ProyectoTaller2
{
   ...
   public interface Iform
    {
        void ActivateButton(object senderBtn, System.Drawing.Color color);
        void openChildForm(Form form);
    }

    //le paso al constructor la interfaz
    public partial class FormMainMenu : Form, Iform 
    {
        ...
        //Constructor
        public FormMainMenu(Usuario objusuario)
        {

            if (objusuario == null)
                usuarioActual = new Usuario() { nombre_usuario = "VENDEDOR PREDEFINIDO", id_usuario = 3 };
            else
        ...
        {
            //Llamamos al metodo de BotonActivo y le mandamos por referencia un valor de la
            //Estructura RGB que creamos
            ActivateButton(sender, RGBColors.color6);
            openChildForm(new FormVentasRegistradas(this));

           // openChildForm(new Form_DetalleVenta());
        ...
        private void btnVenta_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new FormVenta(this, usuarioActual));
        }

        private void btnProductos_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color2);
            openChildForm(new FormProducto(this));
        ...
        private void btnClientes_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new FormCliente(this));
